    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', help_text='名字', max_length=255, verbose_name='名字')),
                ...
                ('img', models.ImageField(blank=True, default='users/image/default.jpg', help_text='头像', max_length=255, null=True, upload_to='users/image/%Y/%m', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, default='', max_length=100, null=True, verbose_name='资源名称')),
                ('content', models.CharField(blank=True, default='', max_length=2000, null=True, verbose_name='资源描述')),
                ('image', models.ImageField(default=None, help_text='资源图片', max_length=255, upload_to='users/image/%Y/%m', verbose_name='资源图片')),
                ('tag', models.CharField(help_text='图片标签', max_length=255, verbose_name='图片标签')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='666666', max_length=10, verbose_name='教师后台密码')),
            ],
            options={
